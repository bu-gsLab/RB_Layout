...
- `--tol` is the tolerance for the horizontal distance between the modules and keepout arc (mm). It will give you all results in this tolerance (if any), along with the a specified number of the best results under tolerance. Best = more module PCBs.
...
- `--under` is how many of the best under-tolerance results to show. 
